...
CREATE TABLE film (
  ...
  watched int COMMENT 'Identificação de filme ja assistido (0 - Sim, 1 - Nao)' NOT NULL DEFAULT 1,
  PRIMARY KEY (id_film)
...
create table usuario (
    ...
    situacao ENUM('ATIVO', 'INATIVO') COMMENT 'Situação da Inspeção: Ativo ou Inativo' NOT NULL DEFAULT 'ATIVO',
